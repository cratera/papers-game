...
export default function InputAvatar({ avatar, onChange }) {
  ...
  return (
    <Fragment>
      <Text nativeID="inputAvatar" style={[Theme.typography.body, Theme.u.center]}>
        Add your avatar
      </Text>
      <TouchableHighlight
      ...
      >
        {avatar ? (
          ...
          <View style={Styles.avatarPlaceContent}>
            { /* prettier-ignore */}
            <Svg style={Styles.avatarSvg} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={Theme.colors.grayDark}>
