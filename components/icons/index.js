...
function useProps(size, color) {
  return {
    inSize: { width: size, height: size },
    baseColor: color || colorNeutral,
  }
}

export const IconLamp = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const IconNonWords = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113 114" {...props}>
...
export const IconEdit = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" {...props}>
...
export const IconEyeOpen = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 19" {...props}>
...
export const IconEyeClosed = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 10"  {...props}>
...
export const IconSpin = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" {...props}>
...
export const IconArrow = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  {...props}>
      <Path d="M5 12h14M12 5l7 7-7 7" stroke={baseColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>
  )
}

export const IconTimes = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const IconCheck = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
    <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const IconGear = ({ size, color, ...props }) /* eslint-disable-line */ => {
  const { inSize, baseColor } = useProps(size, color)
  // prettier-ignore
  return (
  <Svg style={ inSize } fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" {...props}>
