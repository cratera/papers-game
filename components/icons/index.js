...
export const IconExternal = ({ size, color, style, ...props }) /* eslint-disable-line */ => {
  ...
  return (
    <Svg style={ styleWithSize } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <Path fill={baseColor} fill-rule="evenodd" clip-rule="evenodd" d="M15 12.6a.6.6 0 111.2 0v3.6c0 1-.8 1.8-1.8 1.8H7.8c-1 0-1.8-.8-1.8-1.8V9.6c0-1 .8-1.8 1.8-1.8h3.6a.6.6 0 110 1.2H7.8c-.3 0-.6.3-.6.6v6.6c0 .3.3.6.6.6h6.6c.3 0 .6-.3.6-.6v-3.6zM16.8 7.2h-3a.6.6 0 110-1.2h3.6c.3 0 .6.3.6.6v3.6a.6.6 0 01-1.2 0v-3z" />
      <Path fill={baseColor} fill-rule="evenodd" clip-rule="evenodd" d="M11.2 13.6a.6.6 0 11-.8-.8L17 6.2a.6.6 0 11.8.8l-6.6 6.6z" />
    </Svg>
  )
}
...
export const IllustrationCry = props =>
  // prettier-ignore
  <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 271 159" {...props}>
