...
export const IconNonWords = props => {
  // prettier-ignore
  return (
    <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113 114" {...props}>
...
export const IconEyeOpen = props => {
  const color = props.color || baseColor // eslint-disable-line
  // prettier-ignore
  return (
    <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 19" {...props}>
...
export const IconEyeClosed = props => {
  ...
  // prettier-ignore
  return (
    <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 10"  {...props}>
      <Path d="M23 0l-6 3H7L1 0 0 1l3 2-2 3 2 1 2-3 1 1h1L6 8l2 1 1-3h2v3h2V6h2l1 3 2-1-1-3h1l1-1 2 3 2-1-2-3 3-2-1-1z" fill={color} />
    </Svg>
  )
}
...
export const IconSpin = props => {
  ...
  return (
    <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" {...props}>
      <Path d="M11 1v4M11 17v4M4 4l3 3M15 15l3 3M1 11h4M17 11h4M4 18l3-3M15 7l3-3" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>
  )
}
...
export const IconGear = props => {
  const color = props.color || Theme.colors.grayMedium // eslint-disable-line
  // prettier-ignore
  return (
    <Svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" {...props}>
      <Path d="M16 7V6l1-3-2-1-2 1h-1l-2-3H8L7 3H6L4 2 2 3l1 3v1L0 9v2l3 1v1l-1 3 2 1 2-1h1l2 3h2l1-3h1l2 1 2-2-1-2v-1l3-2V8l-3-1zm-6 6a3 3 0 11-1-7 3 3 0 011 7z" fill={color} />
    </Svg>
  )
}
